...
The tests use local mock providers and the repository's Pi bundle, not paid model calls. See `docs/pi-0.87.1-compatibility.md` for this release's verification and `docs/pi-0.87.0-migration.md` for the original migration.
